# Mahta: Creates 5 folds. Each fold has val_df and a train_df. (train_df1,val_df1),...(train_df5,val_df5)
# the dfs are .csv files that include label(geojson file), pre-event, post1,post2, aoi name
...
def main():
    ...
    # Mahta: dataframe including the mapping of all aois put together
